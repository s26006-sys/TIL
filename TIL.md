...
# 배열 리펙토링
리펙토링은 기존의 코드를 유지하며 내부 구조를 개선해 가독성을 높이고 유지보수를 용이하게 하는 과정을 말한다
-> 쉽게 말해서 기능은 똑같은데, 코드를 개선하는 것을 리펙토링이라 한다.
...
## 메서드
메서드란?
메서드는 어떠한 특정 작업을 수행하기 위한 명령문의 집합
